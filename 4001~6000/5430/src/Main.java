...
//    static boolean isPosible = true;
//    static boolean isRight = true;
//
//    static void selectFunc(char func) {
//        switch (func) {
//            case 'R':
//                R();
//                break;
...
//                    list.remove(0);
//                }
//                if (!isRight) list.remove(list.size() - 1);
//            }
//            if (list.isEmpty()) {
//                isPosible = false;
...
//
//            rowStr = br.readLine();
//            c = new char[rowStr.length()];
//            c = rowStr.toCharArray();
//
//            n = Integer.parseInt(br.readLine());
//            arr = new int[n];
//            String input = br.readLine();
//            input = input.substring(1, input.length() - 1); // 괄호 삭제
//            String[] newStr = input.split(","); // , 삭제
//
//            list = new ArrayList<>();
//            for (int i = 0; i < n; i++) {
//                list.add(Integer.parseInt(newStr[i]));
//            }
//
//            isRight = true;
//            isPosible = true;
